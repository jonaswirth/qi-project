...
class RedshiftCNN(nn.Module):
    def __init__(self, input_dim):
        ...
        #Reduce the the output of the convolutional layer to the input size of the quantum layer
        ...
        self.quantum = TorchConnector(create_qnn(NUM_QUBITS))

        #Output the result from the classical layer
...
if __name__ == "__main__":
    ...
    spectra, redshift = load_dataset(DATASET_PATH, num_samples=NUM_SAMPLES, normalize_redshift=True)
