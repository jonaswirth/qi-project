...
if __name__ == "__main__":
    def train_and_evaluate():
        ...
        encoder_optimizer = optim.Adam(imageEncoder.parameters(), lr=0.001)
        ...
        torch.save(imageEncoder.state_dict(), ROOT + "/pretrained/image_encoder.pth")
